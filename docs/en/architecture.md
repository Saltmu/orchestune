...
| **L0** | **Infra**<br/>pure DTOs and dependency-free helpers | `dag_models`, `dispatch_result`, `json_state`, `models`, `outcome_record`, `plan_writer`, `process_utils`, `setup_skills`, `validation`, `version` |
